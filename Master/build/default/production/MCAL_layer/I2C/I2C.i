...
# 13 "MCAL_layer/I2C/../Interrupt/../GPIO/hal_gpio.h"
# 1 "MCAL_layer/I2C/../Interrupt/../GPIO/../device_config.h" 1
# 13 "MCAL_layer/I2C/../Interrupt/../GPIO/hal_gpio.h" 2
# 29 "MCAL_layer/I2C/../Interrupt/../GPIO/hal_gpio.h"
typedef enum
{
    GPIO_PIN0 =0,
    GPIO_PIN1 ,
...
# 15 "MCAL_layer/I2C/../Interrupt/mcal_Interrupt_cfg.h" 2
...
{
    Std_ReturnType ret = (Std_ReturnType)0x00;
    uint8 Dummy_address = 0;
    if((((void*)0) == i2c_obj) || (((void*)0) == i2c_data)){
        ret = (Std_ReturnType)0x00;
    }
    else{

        Dummy_address = SSPBUF;
...
Std_ReturnType MSSP_I2C_Master_Write_Register_Blocking(const mssp_i2c_t *i2c_obj, uint8 i2c_data, uint8 Reg_address,uint8 Slave_Address)
{
    ...
    if((((void*)0) == i2c_obj)){
        ...
        ret = MSSP_I2C_Master_Write_Blocking(i2c_obj,Slave_Address,&ack);
        ret = MSSP_I2C_Master_Write_Blocking(i2c_obj,Reg_address,&ack);
        ret = MSSP_I2C_Master_Write_Blocking(i2c_obj,i2c_data,&ack);
...
Std_ReturnType MSSP_I2C_Master_Read_Register_Blocking(const mssp_i2c_t *i2c_obj, uint8 *i2c_data, uint8 Reg_address,uint8 Slave_Address)
{
    ...
    if((((void*)0) == i2c_obj) || (((void*)0) == i2c_data)){
        ...
        ret = MSSP_I2C_Master_Write_Blocking(i2c_obj,(Slave_Address|0x01),&ack);
        ret = MSSP_I2C_Master_Read_Blocking(i2c_obj,0,i2c_data);
        ret = MSSP_I2C_Master_Send_Stop(i2c_obj);
        ret = (Std_ReturnType)0x01;
    }
    return ret;
