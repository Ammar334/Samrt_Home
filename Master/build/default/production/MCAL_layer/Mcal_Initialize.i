...
# 26 "MCAL_layer/Mcal_Initialize.h" 2
...
uart_t bluetooth = {
    ...
    .uart_rx.uart_rx_9bit_enable = 0,
    .uart_rx.uart_rx_enable = 1,
    .uart_rx.uart_rx_Interrubt_enable = 0,
    .uart_tx.uart_tx_9bit_enable = 0,
    .uart_tx.uart_tx_Interrubt_enable = 0,
    .uart_tx.uart_tx_enable = 1
};
