    ...
    else
    {
        switch(uart_obj->BuadRate_cfg)
        {
            case BUADRATE_ASSYNC_8BIT_LOW_SPEED:
                ...
                (TXSTAbits.BRGH = 0);
                (BAUDCONbits.BRG16 = 0);
                Baudrate_temp = ((8000000UL/uart_obj->BuadRate)/64)-1;
                break;
            case BUADRATE_ASSYNC_8BIT_HIGH_SPEED:
                (TXSTAbits.SYNC = 0);
                (TXSTAbits.BRGH = 1);
                (BAUDCONbits.BRG16 = 0);
                Baudrate_temp = ((8000000UL/uart_obj->BuadRate)/16)-1;
                break;
            ...
            case BUADRATE_ASSYNC_16BIT_HIGH_SPEED:
                ...
                (TXSTAbits.BRGH = 1);
                (BAUDCONbits.BRG16 = 1);
                Baudrate_temp = ((8000000UL/uart_obj->BuadRate)/4)-1;
                break;
